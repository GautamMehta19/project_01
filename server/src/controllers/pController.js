...
const createP = async function (req, res) {
    try {
        ...
        let { UHID, fName, mName, lName, age, gender, title, weight, address, mobile, email, dob, patientImage, visitedDay, investigation } = data
...
const updateVisit = async function (req, res) {
    try {
        let data = req.body
        let pId = req.params.pId
        let { visitedDay, investigation, visitedDate} = data
